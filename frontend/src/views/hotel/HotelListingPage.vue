    ...
    try {
        ...
        if (response.data?.statusCode === 200) {
            ...
            hotels.value = hotelDtos.map(h => ({
                ...
                originalPrice: h.minDiscountedPrice && h.startingPrice && h.minDiscountedPrice < h.startingPrice ? h.startingPrice : null,
                price: h.minDiscountedPrice && h.startingPrice && h.minDiscountedPrice < h.startingPrice ? h.minDiscountedPrice : (h.startingPrice || 0),
