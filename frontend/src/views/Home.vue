    ...
    <div class="container mx-auto px-4 py-8 space-y-16">
      ...
      <section>
        <div class="flex justify-between items-center mb-4">
          <h2 class="text-2xl font-bold text-gray-800">Gợi ý Khách sạn cho bạn</h2>
        </div>
...
const handleScroll = (type) => {
  ...
  if (container) {
    ...
    scrollState[type].canScrollRight = container.scrollLeft < (container.scrollWidth - container.clientWidth - 1);
  }
};
