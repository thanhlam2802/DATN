    ...
    <div class="w-full px-4 sm:px-6 lg:px-2 py-5">
        <div class="relative w-full rounded-md overflow-hidden shadow-md">
            ...
            <div class="absolute inset-0 flex items-center justify-center px-6 py-8">
                <form class="bg-white rounded-md shadow-lg max-w-md w-full p-8">
                    <h2 class="text-center font-extrabold text-xl mb-6">Sign in</h2>

                    <div class="mb-4">
                        <label class="block text-xs font-semibold text-gray-900 mb-1" for="email">Email or Phone</label>
                        <div class="relative">
                    ...
                    <div class="mt-6 flex justify-center space-x-4">
                        <button type="button"
                            class="w-10 h-10 rounded-full bg-red-700 text-white hover:bg-red-600">G</button>
