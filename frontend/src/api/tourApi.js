...
const API_BASE_URL =
  "https://spring-backend-383387500697.asia-southeast1.run.app/api/tours";
...
export const getTourSuggestions = (keyword) => {
  return axios.get(`http://localhost:8080/api/v1/tours/suggestions`, {
    params: { keyword },
  });
};
