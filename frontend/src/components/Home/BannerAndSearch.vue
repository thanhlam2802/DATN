<template>
    <section class="relative w-full h-[500px] mt-4 overflow-hidden rounded-xl">
        <img :src="heroImage" alt="Hình nền du lịch" class="w-full h-full object-cover object-center brightness-50" />
        ...
        <div class="absolute top-4 left-1/2 transform -translate-x-1/2 z-10 w-full px-4 max-w-7xl">
            <div class="rounded-xl p-2">
                            ...
                            <ul
                                ...
                                <li v-for="tab in tabs" :key="tab.id">
                                    <button @click="activeTab = tab.id"
                                        :class="activeTab === tab.id ? 'bg-white text-blue-600 shadow-sm' : 'text-white/80 hover:bg-white/20 hover:text-white'"
                ...
                <div class="rounded-lg">
                    ...
                    <FlightSearch v-if="activeTab === 'flight'" v-model:tripType="tripType" />
                    <BusSearch v-if="activeTab === 'bus'" v-model:busTripType="busTripType" />
...
const heroImage = "https://images.unsplash.com/photo-1534351590666-13e3e96b5017?q=80&w=2940&auto=format&fit=crop";
