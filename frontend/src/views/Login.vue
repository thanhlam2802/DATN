<template>
  <div class="w-full px-4 sm:px-6 lg:px-2 py-5">
      ...
      <div class="absolute inset-0 flex items-center justify-center px-6 py-8">
        ...
        >
          ...
          <div class="flex items-center justify-between mb-6 text-sm">
            ...
            <a href="/forgot-password" class="text-purple-700 hover:underline"
              >Forgot password?</a
            >
          </div>
          ...
          <p class="text-center text-xs mt-4 text-gray-900">
            ...
            <router-link to="/register" class="text-purple-700 hover:underline"
              >Sign up</router-link
            >
          </p>

          <div
            class="mt-6 flex items-center justify-center space-x-4 text-gray-400 text-xs"
          >
          ...
          <div class="mt-6 flex justify-center space-x-4">
            <button
              type="button"
              class="w-10 h-10 rounded-full bg-red-700 text-white hover:bg-red-600"
            >
              G
            </button>
            <button
    ...
    <div
      class="mt-6 flex justify-center space-x-1 text-gray-400 text-xs select-none"
    >
